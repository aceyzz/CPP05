...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/02 16:40:45 by cedmulle          #+#    #+#             */
/*   Updated: 2024/03/02 16:41:05 by cedmulle         ###   ########.ch       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(AForm &src)
{
	if (src.getIsSigned() == true)
	{
		...
		std::cout << GRY1 ", already signed." << std::endl;
		return ;
	}
	else
	{
		...
		else
		{
			...
			std::cout << GRY1 " is too low to sign form " CYAN << src.getName() << std::endl;
			std::cout << GRY1 " (Need grade " REDD << src.getToSign();
